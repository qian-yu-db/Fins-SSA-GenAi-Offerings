...
volume_name_docs = "volume_docs"
VECTOR_SEARCH_ENDPOINT_NAME = "rag_endpoint_qyu"
CHECKPOINTS_VOLUME_PATH = f"/Volumes/{catalog}/{db}/checkpoints"
PDF_SOURCE_PATH = f"/Volumes/{catalog}/{db}/{volume_name_docs}/pdfs"
IMG_SOURCE_PATH = f"/Volumes/{catalog}/{db}/{volume_name_docs}/imgs"
...
print(f"Use Volumes for policy data: {volume_name_docs}")
